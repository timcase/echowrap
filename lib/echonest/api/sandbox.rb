...
module Echonest
  module API
    module Sandbox
      ...
      #   Echonest.sandbox_access(:sandbox => 'emi_evanescence', :id => 'c1b89c9b9e0ee9e53650f1d4e393d716')
      def sandbox_access(options={})
        objects_from_response(Echonest::Asset, :get, '/api/v4/sandbox/access', :assets, options.merge(:oauth_request => true))
      end
    end
  end
end
